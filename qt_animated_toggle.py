...
from PySide6.QtWidgets import QCheckBox, QApplication, QWidget, QVBoxLayout, QLabel
...
class Example(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('AnimatedToggle')
        ...
        self.layout().addWidget(QLabel("Main Toggle"))
        self.layout().addWidget(mainToggle)

        self.layout().addWidget(QLabel("Secondary Toggle"))
        self.layout().addWidget(secondaryToggle)
