# Reference:
# https://doc.qt.io/qtforpython-6.2/examples/example_widgets__widgetsgallery.html
import sys
...
from PySide6.QtCore import (QDateTime, QDir, QLibraryInfo,
                            QSysInfo, QTimer, Qt, qVersion, QCoreApplication, )
from PySide6.QtWidgets import (
    QApplication, QStyleFactory, QHBoxLayout, QWidget, QDialog, QComboBox, QLabel, QCheckBox,
    QDialogButtonBox, QGridLayout, QGroupBox, QPushButton, QToolButton, QMenu, QCommandLinkButton, QVBoxLayout,
    QRadioButton, QToolBox, QTextEdit, QPlainTextEdit, QTextBrowser, QTabWidget, QSizePolicy, QTreeView,
    QFileSystemModel, QTableWidget, QListView, QLineEdit, QSpinBox, QDateTimeEdit, QSlider, QScrollBar, QDial,
    QProgressBar, )
...
def help_url(page):
    ...
    major_version = str(qVersion()).split('.')[0]
